...
class _StatisticsScreenState extends State<StatisticsScreen> {
  final List<CategoryModel> categories = [
    CategoryModel(id: "food", name: "Food", icon: "🍔", color: Colors.purple, userId: ''),
    CategoryModel(id: "shopping", name: "Shopping", icon: "🛍️", color: Colors.orange, userId: ''),
    CategoryModel(id: "bills", name: "Bills", icon: "📄", color: Colors.red, userId: ''),
    CategoryModel(id: "transport", name: "Transport", icon: "🚗", color: Colors.blue, userId: ''),
  ];
    ...
    return Scaffold(
      ...
      body: StreamBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          final categoryTotals = snapshot.data!["categoryTotals"] as Map<String, double>;
